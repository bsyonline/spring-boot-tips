 ...
 */
@Slf4j
public class TimeoutTestCommand extends HystrixCommand<User> {

    private Long id;

    public TimeoutTestCommand(Long id) {
        super(Setter.withGroupKey(HystrixCommandGroupKey.Factory.asKey("UserService")) // group的名字
                ...
                .andThreadPoolPropertiesDefaults(HystrixThreadPoolProperties.Setter()
                        .withCoreSize(10) // 线程池coreSize，默认10
                        .withMaximumSize(10) // 线程池最大线程数
                        .withAllowMaximumSizeToDivergeFromCoreSize(true)
                        .withKeepAliveTimeMinutes(1)
                        .withMaxQueueSize(15) //线程池的最大排队数量
                        .withQueueSizeRejectionThreshold(10)) // 当排队的数量超过阈值则reject
                .andCommandPropertiesDefaults(HystrixCommandProperties.Setter()
                        .withFallbackIsolationSemaphoreMaxConcurrentRequests(30) // fallback的并发数
                        .withCircuitBreakerEnabled(true) // 是否开启短路器，默认是true
                        //.withExecutionTimeoutInMilliseconds(200) // 超时
                        ...
                        .withCircuitBreakerErrorThresholdPercentage(99) // 经过短路器的异常请求比例，默认50
                )
        );
        this.id = id;
    }
